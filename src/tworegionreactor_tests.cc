...
TEST(TwoRegionReactorTests, RefuelTimes) {
  ...
  EXPECT_EQ(n_assem_want*2+3, qr.rows.size()); // +3 because of initial loading
...
// spent fuel inventory buffer. 1 test per spent buffer and 1 test for 
// small capacity on both spent buffers
TEST(TwoRegionReactorTests, FullSpentInventory1) {
  std::string config =
     "  <fuel_inrecipes>  <val>uox</val>  <val>mox</val>    </fuel_inrecipes>  "
     "  <fuel_outrecipes> <val>spentuox</val> <val>spentmox</val> </fuel_outrecipes>  "
     "  <fuel_incommods>  <val>uox</val>   <val>mox</val>   </fuel_incommods>  "
...
TEST(TwoRegionReactorTests, FullSpentInventory2) {
  std::string config =
     "  <fuel_inrecipes>  <val>uox</val>  <val>mox</val>    </fuel_inrecipes>  "
     "  <fuel_outrecipes> <val>spentuox</val> <val>spentmox</val> </fuel_outrecipes>  "
     "  <fuel_incommods>  <val>uox</val>   <val>mox</val>   </fuel_incommods>  "
  ...
  QueryResult qr = sim.db().Query("Transactions", NULL);
  int n_assem_spent = 9; // 3 in spent2, 4 in spent1, and 1 in each region
  // the spent1 ResBuf can still take a batch-worth of assemblies once the 
  // spent2 buffer is full. 
...
TEST(TwoRegionReactorTests, FullSpentInventory3) {
  std::string config =
     "  <fuel_inrecipes>  <val>uox</val>  <val>mox</val>    </fuel_inrecipes>  "
     "  <fuel_outrecipes> <val>spentuox</val> <val>spentmox</val> </fuel_outrecipes>  "
     "  <fuel_incommods>  <val>uox</val>   <val>mox</val>   </fuel_incommods>  "
  ...
  QueryResult qr = sim.db().Query("Transactions", NULL);
  int n_assem_spent = 8; // 3 in spent1, 3 in spent2, and 1 in each region
...
// 1 test for each spent fuel buffer and 1 for both being full. 
TEST(TwoRegionReactorTests, FullSpentInventoryShutdown) {
  ...
  qr = sim.db().Query("TimeSeriesPower", NULL);
  EXPECT_EQ(100, qr.GetVal<double>("Value", 1));

}

TEST(TwoRegionReactorTests, FullSpentInventoryShutdown2) {
  std::string config =
     "  <fuel_inrecipes>  <val>uox</val>  <val>mox</val>    </fuel_inrecipes>  "
     "  <fuel_outrecipes> <val>spentuox</val> <val>spentmox</val> </fuel_outrecipes>  "
     "  <fuel_incommods>  <val>uox</val>   <val>mox</val>   </fuel_incommods>  "
...
TEST(TwoRegionReactorTests, FullSpentInventoryShutdown3) {
  std::string config =
     "  <fuel_inrecipes>  <val>uox</val>  <val>mox</val>    </fuel_inrecipes>  "
     "  <fuel_outrecipes> <val>spentuox</val> <val>spentmox</val> </fuel_outrecipes>  "
     "  <fuel_incommods>  <val>uox</val>   <val>mox</val>   </fuel_incommods>  "
...
// start time.
TEST(TwoRegionReactorTests, FuelShortage1) {
  std::string config =
     "  <fuel_inrecipes>  <val>uox</val>  <val>mox</val>    </fuel_inrecipes>  "
     "  <fuel_outrecipes> <val>spentuox</val> <val>spentmox</val> </fuel_outrecipes>  "
     "  <fuel_incommods>  <val>uox</val>   <val>mox</val>   </fuel_incommods>  "
...
TEST(TwoRegionReactorTests, FuelShortage2) {
  std::string config =
     "  <fuel_inrecipes>  <val>uox</val>  <val>mox</val>    </fuel_inrecipes>  "
     "  <fuel_outrecipes> <val>spentuox</val> <val>spentmox</val> </fuel_outrecipes>  "
     "  <fuel_incommods>  <val>uox</val>   <val>mox</val>   </fuel_incommods>  "
...
TEST(TwoRegionReactorTests, FuelShortage3) {
  std::string config =
     "  <fuel_inrecipes>  <val>uox</val>  <val>mox</val>    </fuel_inrecipes>  "
     "  <fuel_outrecipes> <val>spentuox</val> <val>spentmox</val> </fuel_outrecipes>  "
     "  <fuel_incommods>  <val>uox</val>   <val>mox</val>   </fuel_incommods>  "
  ...
  int simdur = 50;
  cyclus::MockSim sim(cyclus::AgentSpec(":areal:TwoRegionReactor"), config, simdur);
  sim.AddSource("uox").Finalize(); // provide initial full batch
  sim.AddSource("mox").lifetime(1).Finalize();
  sim.AddSource("mox").start(9).lifetime(1).capacity(1).Finalize();
  sim.AddSource("mox").start(15).Finalize();
  sim.AddRecipe("uox", c_uox());
...
TEST(TwoRegionReactorTests, Retire1) {
  std::string config =
     "  <fuel_inrecipes>  <val>lwr_fresh</val> <val>bwr_fresh</val> </fuel_inrecipes>  "
     "  <fuel_outrecipes> <val>lwr_spent</val> <val>bwr_spent</val> </fuel_outrecipes>  "
...
TEST(TwoRegionReactorTests, Record1) {
  /// Test the number of times different TRR events 
  /// are recorded when the exit time doesn't end on 
  /// a cycle end. 
  std::string config =
     "  <fuel_inrecipes>  <val>lwr_fresh</val> <val>bwr_fresh</val> </fuel_inrecipes>  "
     "  <fuel_outrecipes> <val>lwr_spent</val> <val>bwr_spent</val> </fuel_outrecipes>  "
  ...
  // test the number of times anything is recorded for TRR 
  // events
  int num_entries = 39;
  std::vector<Cond> conds;
  conds.push_back(Cond("AgentId", "==", id));
  QueryResult qr = sim.db().Query("TwoRegionReactorEvents", &conds);
  EXPECT_EQ(num_entries, qr.rows.size())
  << "recorded things the wrong number of times" ;

  // test the number of time "RETIRED" is recorded. 
  int num_retired = 1;
  conds.clear();
  conds.push_back(Cond("AgentId", "==", id));
  conds.push_back(Cond("Event", "==", std::string("RETIRED")));
  qr = sim.db().Query("TwoRegionReactorEvents", &conds);
  EXPECT_EQ(num_retired, qr.rows.size())
  << "recorded 'RETIRED' the wrong number of times" ;

  // test the number of time "CYCLE_START" is recorded. 
  int num_start = 6;
  conds.clear();
  conds.push_back(Cond("AgentId", "==", id));
  conds.push_back(Cond("Event", "==", std::string("CYCLE_START")));
  qr = sim.db().Query("TwoRegionReactorEvents", &conds);
  EXPECT_EQ(num_start, qr.rows.size())
  << "recorded 'CYCLE_START' the wrong number of times" ;

  // test the number of time "TRANSMUTE" is recorded.
  int num_transmute = 12;
  conds.clear();
  conds.push_back(Cond("AgentId", "==", id));
  conds.push_back(Cond("Event", "==", std::string("TRANSMUTE")));
  qr = sim.db().Query("TwoRegionReactorEvents", &conds);
  EXPECT_EQ(num_transmute, qr.rows.size())
  << "recorded 'TRANSMUTE' the wrong number of times" ;

  // test the number of time "CYCLE_END" is recorded.
  int num_end = 5;
  conds.clear();
  conds.push_back(Cond("AgentId", "==", id));
  conds.push_back(Cond("Event", "==", std::string("CYCLE_END")));
  qr = sim.db().Query("TwoRegionReactorEvents", &conds);
  EXPECT_EQ(num_end, qr.rows.size())
  << "recorded 'CYCLE_END' the wrong number of times" ;

  // test the number of time "DISCHARGE" is recorded.
  int num_discharge = 15;
  conds.clear();
  conds.push_back(Cond("AgentId", "==", id));
  conds.push_back(Cond("Event", "==", std::string("DISCHARGE")));
  qr = sim.db().Query("TwoRegionReactorEvents", &conds);
  EXPECT_EQ(num_discharge, qr.rows.size())
  << "recorded 'DISCHARGE' the wrong number of times" ;
}

TEST(TwoRegionReactorTests, Record2) {
  /// Test the number of times different TRR events 
  /// are recorded when the exit time does end on 
  /// a cycle end. 
  std::string config =
     "  <fuel_inrecipes>  <val>lwr_fresh</val> <val>bwr_fresh</val> </fuel_inrecipes>  "
     "  <fuel_outrecipes> <val>lwr_spent</val> <val>bwr_spent</val> </fuel_outrecipes>  "
...
// of entries
TEST(TwoRegionReactorTests, TwoRegionOutcommodMissing) {
  std::string config =
     "  <fuel_inrecipes>  <val>uox</val>  <val>mox</val>    </fuel_inrecipes>  "
     "  <fuel_outrecipes> <val>spentuox</val> <val>spentmox</val> </fuel_outrecipes>  "
     "  <fuel_incommods>  <val>uox</val>  <val>mox</val>  </fuel_incommods>  "
...
// of entries
TEST(TwoRegionReactorTests, InrecipesMissing) {
  std::string config =
...
// of entries
TEST(TwoRegionReactorTests, OutrecipesMissing) {
  std::string config =
     "  <fuel_inrecipes>  <val>uox</val>  <val>mox</val>    </fuel_inrecipes>  "
...
// of entries
TEST(TwoRegionReactorTests, AssemsizeMissing) {
  std::string config =
     "  <fuel_inrecipes>  <val>uox</val>  <val>mox</val>    </fuel_inrecipes>  "
     "  <fuel_outrecipes> <val>spentuox</val> <val>spentmox</val> </fuel_outrecipes>  "
     "  <fuel_incommods>  <val>uox</val>  <val>mox</val>   </fuel_incommods>  "
...
// tests that an error is thrown if assem_size input does not have the correct number 
// of entries
TEST(TwoRegionReactorTests, NAssemBatchMissing) {
  std::string config =
     "  <fuel_inrecipes>  <val>uox</val>  <val>mox</val>    </fuel_inrecipes>  "
     "  <fuel_outrecipes> <val>spentuox</val> <val>spentmox</val> </fuel_outrecipes>  "
     "  <fuel_incommods>  <val>uox</val>  <val>mox</val>   </fuel_incommods>  "
...
// of entries
TEST(TwoRegionReactorTests, IncommodMissing) {
  std::string config =
     "  <fuel_inrecipes>  <val>uox</val>  <val>mox</val>    </fuel_inrecipes>  "
     "  <fuel_outrecipes> <val>spentuox</val> <val>spentmox</val> </fuel_outrecipes>  "
